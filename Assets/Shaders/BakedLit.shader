Shader "B1tH0ven/Baked Lit Base"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/Shaders/BakedLitInput.hlsl"
        ...
        Pass
        {
            ...
            #include "Assets/Shaders/BakedLitInput.hlsl"
            #include "Assets/Shaders/BakedLitMetaPass.hlsl"
    ...
    CustomEditor "UnityEditor.Rendering.B1tH0ven.ShaderGUI.BakedLitShader"
}
