#ifndef B1TH0VEN_SIMPLE_LIT_PASS_INCLUDED
#define B1TH0VEN_SIMPLE_LIT_PASS_INCLUDED
...
#ifdef _VERTEX_COLOR
    half4 specular = SampleSpecularSmoothness(uv, alpha, _SpecColor * input.specularColor, TEXTURE2D_ARGS(_SpecGlossMap, sampler_SpecGlossMap));
#else
