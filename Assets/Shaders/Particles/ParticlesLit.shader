...
Shader "Universal Render Pipeline/Particles/Lit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/Shaders/Particles/ParticlesLitInput.hlsl"
            #include "Assets/Shaders/Particles/ParticlesLitForwardPass.hlsl"
            ENDHLSL
        }
        Pass
        {
    ...
    CustomEditor "UnityEditor.Rendering.B1tH0ven.ShaderGUI.ParticlesLitShader"
}
