...
Shader "Universal Render Pipeline/Particles/Simple Lit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/Shaders/Particles/ParticlesSimpleLitInput.hlsl"
            #include "Assets/Shaders/Particles/ParticlesSimpleLitForwardPass.hlsl"
            ENDHLSL
        }
        Pass
        {
    ...
    CustomEditor "UnityEditor.Rendering.B1tH0ven.ShaderGUI.ParticlesSimpleLitShader"
}
