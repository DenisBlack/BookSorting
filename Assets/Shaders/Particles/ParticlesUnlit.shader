Shader "Universal Render Pipeline/Particles/Unlit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/Shaders/Particles/ParticlesUnlitInput.hlsl"
            #include "Assets/Shaders/Particles/ParticlesUnlitForwardPass.hlsl"

            ENDHLSL
        }
    }
    CustomEditor "UnityEditor.Rendering.B1tH0ven.ShaderGUI.ParticlesUnlitShader"
}
