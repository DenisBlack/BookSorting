...
namespace UnityEditor.Rendering.B1tH0ven
{
    public abstract class BaseShaderGUI : UnityEditor.ShaderGUI
    {
        ...
        protected class Styles
        {
            ...
            public static readonly GUIContent customOptions = new GUIContent(
        ...
        protected AnimatedValues.AnimBool m_CustomFoldout;

        protected bool isVertexColor;
        ...
        public override void OnGUI(MaterialEditor materialEditorIn, MaterialProperty[] properties)
        {
            ...
            m_CustomFoldout.value = EditorGUILayout.BeginFoldoutHeaderGroup(m_CustomFoldout.value, Styles.customOptions);
            if (m_CustomFoldout.value)
            {
        ...
        public virtual void OnOpenGUI(Material material, MaterialEditor materialEditor)
        {
            ...
            m_AdvancedFoldout = new AnimatedValues.AnimBool(false);
            m_CustomFoldout = new AnimatedValues.AnimBool(false);
        ...
        public virtual void DrawAdvancedOptions(Material material)
        {
            ...
            {
                material.SetFloat("_VertexColor", EditorGUILayout.Toggle("Vertex Color", material.GetFloat("_VertexColor") > 0.5f) ? 1f : 0f);
            }
        ...
        public static void SetMaterialKeywords(Material material, Action<Material> shadingModelFunc = null, Action<Material> shaderFunc = null)
        {
            ...
            if (material.HasProperty("_VertexColor"))
                CoreUtils.SetKeyword(material, "_VERTEX_COLOR", material.GetFloat("_VertexColor") >= 0.5f);
            // Normal Map
            if(material.HasProperty("_BumpMap"))
                CoreUtils.SetKeyword(material, "_NORMALMAP", material.GetTexture("_BumpMap"));
            // MainTex
            if (material.HasProperty("_BaseMap"))
                CoreUtils.SetKeyword(material, "_BASEMAP", material.GetTexture("_BaseMap"));
